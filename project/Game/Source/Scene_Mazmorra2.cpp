...
bool Scene_Mazmorra2::Awake(pugi::xml_node config)
{
	LOG("Loading Scene_Mazmorra2");
	bool ret = true;
	if(!active){
		return ret;
	}
...
bool Scene_Mazmorra2::Start()
{
	...
	// L15: DONE 2: Instantiate a new GuiControlButton in the Scene_Mazmorra2

	/*SDL_Rect btPos = { windowW / 2 - 60,20, 120,20};
	gcButtom = (GuiControlButton*) app->guiManager->CreateGuiControl(GuiControlType::BUTTON, 1, "MyButton", btPos, this);*/

	if (app->questManager->GetQuestLineIndex(1) <= 11) {
		app->questManager->UpdateQuestLine(1, 12);
	}
...
bool Scene_Mazmorra2::PreUpdate()
{
	return true;
}

// Called each loop iteration
bool Scene_Mazmorra2::Update(float dt)
{
...
// Called each loop iteration
bool Scene_Mazmorra2::PostUpdate()
{
	bool ret = true;
...
bool Scene_Mazmorra2::OnGuiMouseClickEvent(GuiControl* control)
{
...
int Scene_Mazmorra2::GetSceneNumber()
{
	return sceneLevel;
}

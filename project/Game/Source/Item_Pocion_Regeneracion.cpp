...
bool Item_Pocion_Regeneracion::Awake() {
...
bool Item_Pocion_Regeneracion::Start() {
...
bool Item_Pocion_Regeneracion::Update(float dt)
{
...
bool Item_Pocion_Regeneracion::PostUpdate()
{
	app->render->DrawTexture(texture, position.x, position.y, 0.5f);
	return true;
}

bool Item_Pocion_Regeneracion::CleanUp()
{

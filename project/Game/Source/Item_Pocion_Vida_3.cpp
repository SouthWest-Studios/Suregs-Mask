...
bool Item_Pocion_Vida_3::Update(float dt)
{
...
bool Item_Pocion_Vida_3::PostUpdate()
{
	app->render->DrawTexture(texture, position.x, position.y, 0.5f);
	return true;
}

bool Item_Pocion_Vida_3::CleanUp()
{

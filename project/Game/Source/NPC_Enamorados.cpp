...
NPCEnamorados::NPCEnamorados() : Entity(EntityType::NPC_ENAMORADOS)
{
	name = ("npc_enamorados");

}

NPCEnamorados::~NPCEnamorados() {

}

bool NPCEnamorados::Awake() {
...
bool NPCEnamorados::Update(float dt)
{
...
void NPCEnamorados::OnCollision(PhysBody* physA, PhysBody* physB) {
	switch (physB->ctype)
	{

...
bool Item_Pocion_Vida_Max::Awake() {
...
bool Item_Pocion_Vida_Max::Start() {
...
bool Item_Pocion_Vida_Max::Update(float dt)
{
...
bool Item_Pocion_Vida_Max::PostUpdate()
{
	app->render->DrawTexture(texture, position.x, position.y, 0.5f);
	return true;
}

bool Item_Pocion_Vida_Max::CleanUp()
{

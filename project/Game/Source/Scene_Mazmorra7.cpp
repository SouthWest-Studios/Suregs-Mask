...
bool Scene_Mazmorra7::Awake(pugi::xml_node config)
{
	LOG("Loading Scene_Mazmorra7");
	bool ret = true;
	if(!active){
		return ret;
	}
...
bool Scene_Mazmorra7::Start()
{
	...
	// L15: DONE 2: Instantiate a new GuiControlButton in the Scene_Mazmorra7
...
bool Scene_Mazmorra7::PreUpdate()
{
	return true;
}

// Called each loop iteration
bool Scene_Mazmorra7::Update(float dt)
{
...
// Called each loop iteration
bool Scene_Mazmorra7::PostUpdate()
{
	bool ret = true;
...
bool Scene_Mazmorra7::CleanUp()
{
	LOG("Freeing Scene_Mazmorra7");
...
bool Scene_Mazmorra7::OnGuiMouseClickEvent(GuiControl* control)
{

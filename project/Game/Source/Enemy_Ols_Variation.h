#ifndef __ENEMY_OLS_VARIATION_H__
#define __ENEMY_OLS_VARIATION_H__
...
struct Branch_Ols_Variation {
	enum EntityState_Enemy const next_state;
	Branch_Ols_Variation(EntityState_Enemy next) : next_state(next) {}
};

class Enemy_Ols_Variation : public Entity
{
...
public:
	...
	Branch_Ols_Variation transitionTable[static_cast<int>(EntityState_Enemy::STATE_COUNT)][static_cast<int>(EntityState_Enemy::STATE_COUNT)] = {
...
#endif // __Enemy_Ols_Variation_H__

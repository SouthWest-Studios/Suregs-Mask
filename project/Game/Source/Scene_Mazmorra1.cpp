...
bool Scene_Mazmorra1::Awake(pugi::xml_node config)
{
	LOG("Loading Scene_Mazmorra1");
	bool ret = true;
	if(!active){
		return ret;
	}
...
bool Scene_Mazmorra1::Start()
{
	...
	// L15: DONE 2: Instantiate a new GuiControlButton in the Scene_Mazmorra1

	/*SDL_Rect btPos = { windowW / 2 - 60,20, 120,20};
	gcButtom = (GuiControlButton*) app->guiManager->CreateGuiControl(GuiControlType::BUTTON, 1, "MyButton", btPos, this);*/

	if (app->questManager->GetQuestLineIndex(1) == 10) {
		app->questManager->UpdateQuestLine(1, 11);
	}
...
bool Scene_Mazmorra1::PreUpdate()
{
	return true;
}

// Called each loop iteration
bool Scene_Mazmorra1::Update(float dt)
{
...
// Called each loop iteration
bool Scene_Mazmorra1::PostUpdate()
{
	bool ret = true;
...
bool Scene_Mazmorra1::CleanUp()
{
	LOG("Freeing Scene_Mazmorra1");
...
bool Scene_Mazmorra1::OnGuiMouseClickEvent(GuiControl* control)
{
...
int Scene_Mazmorra1::GetSceneNumber()
{
	return sceneLevel;
}
